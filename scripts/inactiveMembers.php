...
<?php include('header.php');?>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="allMembers.php"><i class="fa fa-circle-o"></i> All Members</a></li>
			      <li class="active"><a href="inactiveMembers.php"><i class="fa fa-circle-o"></i> Inactive Members</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <img class="borderDloadImg" src="../dist/img/excel_download.png" title="Export to Excel" onclick="ExportToExcel('example1', 'Inactive Members')"/> 	
            <!-- /.box-header -->
			<table id="example1" class="table table-bordered table-striped">
                ...
                <th>Status</th>
                <th>Last Login</th>
                <th>Date De-Activated</th>
                <th></th>
                </tr>
                </thead>
                <tbody>
				<?php 
        $members = DB::query('SELECT * from members where AccStatus=%s order by Id desc', 'Inactive');
          ...
          <td><?php echo $member['AccStatus'];?></td> 
          <td><?php echo date_format(date_create($member['LastLogin']), 'd-m-Y');?></td>
          <td><?php echo date_format(date_create($member['DateUpdated']), 'd-m-Y');?></td>
...
<div class="modal-header bg-blue color-palette">
      ...
      <div class="form-group col-sm-2">
          ...
          <input type="text" class="form-control" id="InputName" style="text-transform:uppercase" name="AccNumber" placeholder="GT001" autocomplete="off" required>
        </div>
				<div class="form-group col-sm-4">
          <label for="InputName">Name</label>
          <input type="text" class="form-control" id="InputName" name="Name" placeholder="Enter Name" autocomplete="off" required>
        </div>
