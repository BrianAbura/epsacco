  ...
  <div class="wrapper">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-1">
                      ...
                      <input type="text" class="form-control" id="Rate" name="Rate" min=1 value="1" readonly />
                    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            The lender lends the borrower the principal requested for the specified period to be paid to the lender as principle and interest (Total Amount) there at the rate of <b>1%</b> per month at reducing balance for Main Loans and <b>10%</b> per month for loan Top-Up's.<br /><br />
    ...
    <script>
      ...
      InputAmount.onchange = function() {
        NewInputAmount = InputAmount.value.replace(/,/g, "");
        if (NewInputAmount > 20000000) {
          alertify.alert("Error!", "You cannot make a loan request of more than <b>UGX 20,000,000.</b>");
          InputAmount.value = "";
        }
        Interest.value = (NewInputAmount * (Rate.value / 100));
        if (NewInputAmount == "") {
